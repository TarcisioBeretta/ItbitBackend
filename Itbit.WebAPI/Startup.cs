...
using Itbit.WebAPI.Inbound.MapperProfiles;
...
namespace Itbit.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ItbitContext>();

            var mappingConfig = new MapperConfiguration(mc =>
            {
                mc.AddProfile(new UsuarioMapperProfile());
                mc.AddProfile(new SexoMapperProfile());
            });
